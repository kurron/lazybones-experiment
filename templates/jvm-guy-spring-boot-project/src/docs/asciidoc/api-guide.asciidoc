...
include::{snippets}/failure-scenario/httpie-request.adoc[]
include::{snippets}/failure-scenario/curl-request.adoc[]
include::{snippets}/failure-scenario/http-request.adoc[]
include::{snippets}/failure-scenario/request-headers.adoc[]
include::{snippets}/failure-scenario/http-response.adoc[]
include::{snippets}/failure-scenario/response-fields.adoc[]

Example of documenting links
include::{snippets}/failure-scenario/links.adoc[]
...
include::{snippets}/get-my-resource/httpie-request.adoc[]
include::{snippets}/get-my-resource/curl-request.adoc[]
include::{snippets}/get-my-resource/http-request.adoc[]
include::{snippets}/get-my-resource/http-response.adoc[]

IMPORTANT: If this were a real API, would document both the request and response fields.
...
might be `application/hal+json;version=1.2.3`.
